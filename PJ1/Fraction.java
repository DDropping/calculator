package PJ1; public class Fraction implements FractionInterface, Comparable<Fraction> { private	int num;	private	int den;	public Fraction() { setFraction(0, 1); } public Fraction(int num, int den) { setFraction(num, den); }	public void setFraction(int num, int den) { this.num = num; if (den == 0) throw new Project1Exception("Denominator is 0"); this.den= den; adjustSigns(); reduceFractionToLowestTerms(); }	
